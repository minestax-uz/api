...
@Entity({ database: 's32_rank', name: 'luckperms_players' })
export class Player extends RootPlayer {}

@Entity({ database: 's32_rank', name: 'luckperms_groups' })
export class Group extends RootGroup {}

@Entity({ database: 's32_rank', name: 'luckperms_group_permissions' })
export class GroupPermissions extends RootGroupPermissions {}

@Entity({ database: 's32_rank', name: 'luckperms_user_permissions' })
